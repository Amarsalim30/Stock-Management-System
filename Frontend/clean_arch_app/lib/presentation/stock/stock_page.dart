...
class StockPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context) {
    return ProviderScope(
      overrides: [
        StockViewModelProvider.overrideWithProvider(
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(icon: Icon(Icons.refresh), onPressed: viewModel.refresh),
      ...
      body: Column(
        children: [
          ...
          if (viewModel.hasSelectedItems) _buildBulkActions(context, ref),
        ],
      ),
    );
  }
